        ...
        <div class="card shadow w-80">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-center">
              ...
              <a href="<?= base_url('keranjang/add/') . $f['id_favorit']; ?>" class="btn btn-sm btn-danger btn-add" data-toggle="tooltip" data-placement="right" title="Hapus dari Favorit" id="info">
